...
public interface ImovelResidencialRepository extends Repository<ImovelResidencial> {
	...
	/**
	 * Busca todos os imóveis resindenciais que possuem o número informado
	 * @param numeroImovel
	...
	/**
	 * Busca todos os imoveis resindenciais com o rgi informado
	...
	/**
	 * Busca todos os imoveis resindenciais com o nome de locatario informado
